    ...
    <div className="w-[166px] h-screen bg-[url('/back.png')] bg-cover bg-no-repeat bg-center text-white p-4 mx-auto flex flex-col items-center pt-[48px] rounded-l-[10px]">
      ...
      <div className="mt-24">
        <button
          ...
          className={`flex items-center justify-center gap-2 w-[150px] h-[48px] mb-4 rounded-[10px] text-sm font-medium text-white transition-colors duration-200 ${
            view === 'speech' ? 'bg-[#02816E]' : 'bg-[#00BA9F] hover:bg-[#00BA9F]'
          }`}
        >
        ...
        <button
          ...
          className={`flex items-center justify-center gap-2 w-[150px] h-[48px] rounded-[10px] text-sm font-medium text-white transition-colors duration-200 ${
            view === 'archive' ? 'bg-[#02816E]' : 'bg-[#096f60] hover:bg-[#00ba9e9c]'
          }`}
        >
